...
const FooterContainer = styled.footer`
  ...
  @media (min-width: 1024px) {
    left: 350px; /* Start after chat sidebar */
    padding: 0 4rem;
  }
`
  ...
  return (
    <FooterContainer>
      <FooterContent>
        ...
        <LegalLinks>
          <LegalLink href="#" onClick={(e) => e.preventDefault()}>Provably Fair</LegalLink>
          <LegalLink href="#" onClick={(e) => e.preventDefault()}>Privacy Policy</LegalLink>
          <LegalLink href="#" onClick={(e) => e.preventDefault()}>Terms of Service</LegalLink>
          <LegalLink href="#" onClick={(e) => e.preventDefault()}>Support</LegalLink>
        </LegalLinks>
      </FooterContent>
    </FooterContainer>
  )
